...
const REMIX_IDEAS = [
    "باش تجرب تسريحات شعر مختلفة.",
    "باش تحول حيوانك الأليف لشخصية كرتونية.",
    "باش تصاوب نسخة خيالية من راسك.",
    "باش تصمم بطل خارق من تصويرتك.",
    "باش تحط راسك فأحداث تاريخية مشهورة.",
    "باش تصاوب أفاتار ديال لعبة فيديو خاصة بك.",
];
        ...
        <footer className="fixed bottom-0 left-0 right-0 bg-black/50 backdrop-blur-sm p-3 z-50 text-neutral-300 text-xs sm:text-sm border-t border-white/10">
            <div className="max-w-screen-xl mx-auto flex justify-between items-center gap-4 px-4">
                ...
                <div className="hidden md:flex items-center gap-4 text-neutral-500 whitespace-nowrap">
                    <p>مدعوم ب Gemini 2.5 Flash Image Preview</p>
                ...
                <div className="flex-grow flex justify-end items-center gap-4 sm:gap-6">
                    <div className="hidden lg:flex items-center gap-2 text-neutral-400 text-right min-w-0">
                        <span className="flex-shrink-0">بدل فهاد التطبيق...</span>
                        <div className="relative w-72 h-5">
                            <AnimatePresence mode="wait">
                                <motion.span
                                    ...
                                    className="absolute inset-0 font-medium text-neutral-200 whitespace-nowrap text-right"
                                >
                                    {REMIX_IDEAS[index]}
                                </motion.span>
                            </AnimatePresence>
